...
abstract class BaseDialogFragment<S: ViewState, E: ViewStateEvent, X: ViewStateEffect, V: BaseViewModel<S, E, X>>(layoutResId: Int): DialogFragment(layoutResId) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with (requireActivity() as AppCompatActivity) {
            ...
            val navController = NavHostFragment.findNavController(this@BaseDialogFragment)
